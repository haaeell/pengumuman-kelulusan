    ...
    <style>
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Konfigurasi tanggal & waktu pengumuman kelulusan siswa</p>
            </div>
                ...
                <div class="panel-body">
                    ...
                    @if (!$ann)
                        ...
                        <div class="status-banner empty">
                            ...
                            <p class="text-xs text-gray-400 mt-1 mb-4">Atur tanggal & waktu pengumuman kelulusan agar siswa dapat mengecek
                                hasilnya</p>
                    ...
                    @else
                        @php
                            ...
                            $announcementDateTime = \Carbon\Carbon::parse($ann->announcement_date);
                            $isPast = $announcementDateTime->isPast();
                            $isToday = $announcementDateTime->isToday();
                        @endphp
                                ...
                                <div class="text-right">
                                    <div>
                                        <span class="date-display">
                                            ...
                                            {{ $announcementDateTime->translatedFormat('d F Y') }}
                                        </span>
                                    </div>
                                    <div>
                                        <span class="time-display">
                                            <i class="fa-solid fa-clock text-[11px]"></i>
                                            {{ $announcementDateTime->format('H:i:s') }} WIB
                                        </span>
                                    </div>
                                    <div class="mt-1.5">
                                        @if ($isToday)
                                        ...
                                        @elseif ($isPast)
                                            <span class="countdown-chip past">
                                                ...
                                                {{ $announcementDateTime->diffForHumans() }}
                                            </span>
                                        @else
        ...
        <div id="addModal" class="modal">
            <form method="POST" action="{{ route('announcements.store') }}" class="modal-box">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">Waktu Pengumuman <span class="text-red-400">*</span></label>
                        <div class="time-input-group">
                            <div class="time-input-wrapper">
                                <label>Jam</label>
                                <input type="number" name="announcement_hour" class="form-control" min="0" max="23" 
                                    value="08" placeholder="08" required>
                            </div>
                            <div class="time-input-wrapper">
                                <label>Menit</label>
                                <input type="number" name="announcement_minute" class="form-control" min="0" max="59" 
                                    value="00" placeholder="00" required>
                            </div>
                            <div class="time-input-wrapper">
                                <label>Detik</label>
                                <input type="number" name="announcement_second" class="form-control" min="0" max="59" 
                                    value="00" placeholder="00" required>
                            </div>
                        </div>
                        <p class="text-[11px] text-gray-400 mt-1.5">Waktu pengumuman akan dibuka (Format 24 jam)</p>
                    </div>
                    <div class="form-group">
        ...
        @if ($ann)
            @php
                $editDateTime = \Carbon\Carbon::parse($ann->announcement_date);
            @endphp
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="announcement_date" type="date" class="form-control"
                                value="{{ $editDateTime->format('Y-m-d') }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Waktu Pengumuman <span class="text-red-400">*</span></label>
                            <div class="time-input-group">
                                <div class="time-input-wrapper">
                                    <label>Jam</label>
                                    <input type="number" name="announcement_hour" class="form-control" min="0" max="23" 
                                        value="{{ $editDateTime->format('H') }}" required>
                                </div>
                                <div class="time-input-wrapper">
                                    <label>Menit</label>
                                    <input type="number" name="announcement_minute" class="form-control" min="0" max="59" 
                                        value="{{ $editDateTime->format('i') }}" required>
                                </div>
                                <div class="time-input-wrapper">
                                    <label>Detik</label>
                                    <input type="number" name="announcement_second" class="form-control" min="0" max="59" 
                                        value="{{ $editDateTime->format('s') }}" required>
                                </div>
                            </div>
                            <p class="text-[11px] text-gray-400 mt-1.5">Format 24 jam</p>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Deskripsi <span class="text-gray-300 font-400">(opsional)</span></label>
